...
const Recurso = () => {
        ...
        if(!recurso.id) {
            ...
            .then((res) => {
                ...
                toast.current?.show({
                    severity: 'info',
                    summary: 'Sucesso!',
                    detail: 'Recurso cadastrado com suscesso!'
                });
            }).catch((error) => {
                console.log(error);
                toast.current?.show({
            ...
            .then((res) => {
                ...
                toast.current?.show({
                    severity: 'success',
                    summary: 'Sucesso!',
                    detail: 'Recurso atualizado com suscesso!'
                });
            })
            .catch((error) => {
                console.log(error);
        ...
        if(recurso.id){
            ...
            .then((res) => {
                ...
                toast.current?.show({
                    severity: 'error',
                    summary: 'Erro!',
                    detail: 'Não foi possível deletar o recurso!',
                });
            })
    ...
    const deleteSelectedRecursos = () => {
        ...
        Promise.all(selectedRecursos.map(async (_recurso) => {
            ...
            toast.current?.show({
                severity: 'error',
                summary: 'Erro!',
                detail: 'Erro ao deletar os recursos!',
            });
        })
    ...
    const deleteRecursosDialogFooter = (
        <>
            <Button label="No" icon="pi pi-times" text onClick={hideDeleteRecursosDialog} />
            ...
            <div className="col-12">
                <div className="card">
                    ...
                    >
                        ...
                        <Column field="login" header="Chave" sortable body={chaveBodyTemplate} headerStyle={{ minWidth: '15rem' }}></Column>
